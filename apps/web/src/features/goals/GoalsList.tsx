    ...
    <div style={{ padding: "1.5rem" }}>
      ...
      {loading ? (
        ...
        <div
          ...
          style={{ padding: "3rem", textAlign: "center", borderRadius: "var(--radius-xl)" }}
        >
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      alignItems: "center",
                      gap: "0.25rem",
                      color: strengthScore > 0 ? "#10b981" : "var(--color-ink-3)",
                    }}
                  >
                  ...
                  >
                    <div
                      style={{
                        height: "100%",
                        width: `${pct}%`,
                        background: completed ? "var(--color-primary)" : "var(--color-ink-2)",
                        borderRadius: "4px",
