  ...
  if (media.kind === "photo") {
    return (
      <img
        src={url}
        alt="attachment"
        style={{ width: 80, height: 80, objectFit: "cover", borderRadius: "var(--radius-lg)" }}
      />
    );
  }
  ...
  return (
    <div style={{ padding: "1rem", position: "relative", minHeight: "100vh" }}>
      ...
      >
        ...
        <Link to="/settings" style={{ color: "var(--color-ink-3)", textDecoration: "none" }}>
          Settings
        </Link>
      </header>
      {loading ? (
                ...
                >
                  {entry.scales.map((s: any) => (
                    ...
                    >
                      ...
                      <span style={{ fontWeight: "600", color: "var(--color-ink-1)" }}>
                        {s.value}
                      </span>
